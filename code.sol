...
/// @custom:proxied true
/// @custom:deploy 0x5270000000090000000000000000000000000052
/// @title L1 Block
...
contract L1Block is ISemver {
    ...
    function DEPOSITOR_ACCOUNT() private pure returns (address addr_) {
        addr_ = Constants.DEPOSITOR_ACCOUNT;
    }

    /// @notice The latest L2 block number known by the L1 system.
    uint64 public number;

    /// @notice The latest L2 timestamp known by the L2 system.
    uint64 public timestamp;

    /// @notice The latest L1 base fees.
    uint256 public base fee;
